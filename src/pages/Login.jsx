...
import thanhPhatIcon from '../assets/thanhphat-logo.png'
...
function Login() {
  ...
  return (
    <Box sx={{
      ...
      background: 'url("src/assets/thanhphat-bg-img.jpeg")',
        ...
        <Zoom in={true} style={{ transitionDelay: '200ms' }}>
          <MuiCard sx={{ minWidth: 380, maxWidth: 380, marginTop: '6em', p: '0.5em 0', borderRadius: 2 }}>
            <Box sx={{ width: '70px', bgcolor: 'white', margin: '0 auto' }}>
              <img src={thanhPhatIcon} alt='thanhPhat' width='100%' />
            </Box>
            <Box sx={{ display: 'flex', justifyContent: 'center', color: theme => theme.palette.grey[500] }}>
              <Box>
                <Typography>Hint: thanhphat.official@gmail.com</Typography>
                <Typography>Pass: thanhphat@123</Typography>
              </Box>
            </Box>
